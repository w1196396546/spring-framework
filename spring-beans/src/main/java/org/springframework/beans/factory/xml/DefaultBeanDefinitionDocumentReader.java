...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	...
	protected void doRegisterBeanDefinitions(Element root) {
		System.out.println("DefaultBeanDefinitionDocumentReader:element root:"+root.getChildNodes().getLength());
		...
		System.out.println("DefaultBeanDefinitionDocumentReader:parent"+parent);
		System.out.println("DefaultBeanDefinitionDocumentReader:this.delegate"+this.delegate);
	...
	protected void importBeanDefinitionResource(Element ele) {
		...
		System.out.println("DefaultBeanDefinitionDocumentReader:location"+location);
		// 为空，直接退出
		...
		try {
			absoluteLocation = ResourcePatternUtils.isUrl(location)// 以 classpath*: 或者 classpath: 开头的为绝对路径;能够通过该 location 构建出 java.net.URL 为绝对路径。
					|| ResourceUtils.toURI(location).isAbsolute();//<2> 根据 location 构造 java.net.URI 判断调用 #isAbsolute() 方法，判断是否为绝对路径。
		}
		...
		System.out.println("DefaultBeanDefinitionDocumentReader:absoluteLocation"+absoluteLocation);
		if (absoluteLocation) {
			try {
